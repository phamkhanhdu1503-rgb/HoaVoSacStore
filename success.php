            ...
            <div class="col-sm-11 col-md-9 col-lg-6">
                ...
                <div class="card success-card text-center">
                    ...
                    <p class="text-muted small px-3">
                        Cảm ơn bạn đã tin tưởng và lựa chọn những bông hoa tươi thắm tại <b>Hoa Vô Sắc</b>. Đơn hàng của
                        bạn đang được hệ thống tiếp nhận xử lý.
                    </p>

                    <hr class="my-4">

                    <div class="text-start mb-4">
                        <h6 class="fw-bold text-dark mb-3"><i class="bi bi-receipt me-2" style="color: #ff758f;"></i>Tóm
                            tắt đơn hàng</h6>
                        ...
                        <div class="order-info-box">
                            ...
                            <div class="info-row">
                                ...
                                <span
                                    class="info-value"><?= date("d/m/Y H:i", strtotime($order['created_at'])); ?></span>
                            </div>
                            ...
                            <div class="info-row border-0 pt-3">
                                <span class="info-label text-dark fw-bold" style="font-size: 16px;">Tổng thanh
                                    toán</span>
                                <span class="info-value text-danger"
                                    style="font-size: 18px; color: #a81c39 !important;">
