        ...
        <div class="row g-4">
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="card glass-card text-center py-5">
                    ...
                    <h4 class="fw-bold text-dark mb-1"><?= htmlspecialchars($user['fullname'] ?? 'Chưa cập nhật tên') ?>
                    </h4>
                    ...
                    <div class="text-start px-3">
                        ...
                        <div class="d-flex align-items-center gap-3 text-secondary small">
                            ...
                            <div>
                                ...
                                <span class="text-muted" style="font-size: 12px;">Dùng để định vị khi ship hoa tốc
                                    hành</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="card glass-card">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-muted small m-0 mt-1">Vui lòng điền đúng thông tin để nhận được các ưu đãi thành
                            viên</p>
                    </div>

                    <?php if (!empty($success)): ?>
                        <div class="alert alert-success p-3 mb-4 d-flex align-items-center gap-2"
                    ...
                    <?php if (!empty($error)): ?>
                        <div class="alert alert-danger p-3 mb-4 d-flex align-items-center gap-2"
                            style="background-color: #ffe5ec; color: #dc3545;">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <label class="form-label-custom"><i class="bi bi-person-fill me-1"></i> Họ và
                                    tên</label>
                                <input type="text" name="fullname"
                                    value="<?= htmlspecialchars($user['fullname'] ?? '') ?>"
                                    class="form-control form-control-custom" placeholder="Nhập họ và tên đầy đủ"
                                    required>
                            </div>

                            <div class="col-md-6 mb-4">
                                <label class="form-label-custom"><i class="bi bi-envelope-fill me-1"></i> Địa chỉ
                                    Email</label>
                        ...
                        <div class="mb-4">
                            <label class="form-label-custom"><i class="bi bi-telephone-fill me-1"></i> Số điện
                                thoại</label>
                        ...
                        <div class="mb-4">
                            <label class="form-label-custom"><i class="bi bi-geo-alt-fill me-1"></i> Địa chỉ giao nhận
                                hoa</label>
                        ...
                        <div class="mb-4">
                            <label class="form-label-custom"><i class="bi bi-image me-1"></i> Thay đổi ảnh đại diện
                                mới</label>
                            <input type="file" name="avatar" class="form-control" accept="image/*">
                            <div class="form-text ps-2 small text-muted mt-2">Định dạng khuyên dùng: JPG, PNG, WEBP tỷ
                                lệ vuông.</div>
                        </div>
